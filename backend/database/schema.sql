...
--
-- Host: localhost    Database: ice_factory
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'c0aa65ed-0b29-11f1-a0f0-106fd94bc676:1-7';
...
CREATE TABLE `payment` (
  ...
  CONSTRAINT `transaction_id` FOREIGN KEY (`transaction_id`) REFERENCES `purchase` (`transaction_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'ice_factory'
--
...
-- Dump completed on 2026-03-17 16:26:20
